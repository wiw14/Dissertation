...
void run_heuristic(int input,vector<double>*vars) {
    if(input == 1) //Greedy heuristic.
        ...
        KMeansClustering::createClusters(vars->at(7));
        CACOHeuristic((int)vars->at(0), (int)vars->at(1), (int)vars->at(2),vars->at(3),vars->at(4),vars->at(5),vars->at(6),(int)vars->at(8), (int)vars->at(9));
