...
def displayTemp():
    ...
    partitionOne = [13, 11, 4, 3, 6, 8, 0, 12, 15, 18, 20, 17, 9, 7, 5, 2, 1, 10, 14, 21, 19, 16, 13]
    partitionTwo = [8, 6, 2, 5, 7, 9, 12, 15, 18, 20, 17, 14, 21, 0, 19, 16, 11, 4, 3, 1, 10, 13, 8]
    ...
    partitionThree = [0, 8, 12, 21, 19, 13, 9, 11, 16, 10, 17, 14]
    partitionFour = [1, 2, 3, 6]
