...
def displayTemp():
    ...
    # partitionOne = [0,5,7,9,13,11,4,3,2,1,6,8,10,17,20,18,15,12,16,19,21,14,0]
    ...
    #partitionThree = [4,3,18,20,1,2,6,10,9,7,5,8,11,13,17,19,16,0,15,21,14,12,4]
    #partitionFour = [12,15,17,9,7,5,2,1,13,11,4,20,21,3,6,8,10,16,14,18,19,0,12]
